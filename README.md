...
sh
  cd my-folder
  git clone https://github.com/Ceemos96/school-library
...
Feel free to check the [issues page](https://github.com/Ceemos96/school-library/issues/).
...
This project is [MIT](https://github.com/Ceemos96/school-library/blob/dev/LICENSE) licensed.
